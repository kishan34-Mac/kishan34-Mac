...
def generate_skills_svg(config_path="config.yml", output_path="assets/skills.svg"):
    ...
    raw_skills = config.get("skills", [
        ...
        {"name": "Next.js / React", "level": 84, "category": "Web"},
        {"name": "TypeScript", "level": 82, "category": "Web"},
        {"name": "Python / PyTorch", "level": 78, "category": "AI / ML"},
        {"name": "Kotlin / Android", "level": 74, "category": "Mobile"},
        {"name": "Deep Learning", "level": 70, "category": "AI / ML"},
        {"name": "Model Deployment", "level": 68, "category": "AI / ML"},
